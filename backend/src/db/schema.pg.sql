-- =========================================================
-- CipherCube — esquema PostgreSQL (producción)
-- Espejo de schema.sql con tipos nativos de PostgreSQL:
--   · marcas de tiempo  -> TIMESTAMPTZ
--   · montos            -> DOUBLE PRECISION
--   · banderas booleanas-> INTEGER 0/1 (paridad con SQLite y el binding)
-- =========================================================
